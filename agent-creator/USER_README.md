...
| **Shared skill** | Reusable across agents — created alongside the agent, packaged in a separate skills ZIP that ships next to the agent bundle |
...
├── {name}-skills.zip                   # (Optional) new shared skills created for this agent
