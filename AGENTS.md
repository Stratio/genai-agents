...
**What gets translated:** `AGENTS.md`, `SKILL.md`, sub-guides (`*.md` inside `skills/`), `guides/*.md` (root-level and per-agent), `USER_README.md`, per-artifact `README.md` (one per agent / plugin / shared skill — i.e. `agents/<name>/README.md`, `plugins/<name>/README.md`, `skills/<name>/README.md`), `cowork-metadata.yaml`.
