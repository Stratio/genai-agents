...
- Para formatos de fichero (PDF, DOCX, PPTX, Dashboard web, Informe web/Artículo web, Póster/Infografía, XLSX): resuelve el tema de marca a través de la cascada del agente host, carga la writer skill correspondiente y produce el entregable aplicando tokens de marca y siguiendo `quality-report-layout.md`.
