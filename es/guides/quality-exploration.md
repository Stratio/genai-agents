...
Para el workflow estándar de descubrimiento (listar dominios, regla crítica de domain_name, explorar tablas, detalle de tablas y columnas), seguir las secciones 5.1 a 5.4 de `guides/stratio-data-tools.md`.
...
Para las reglas base de uso de `profile_data` (generar SQL con `generate_sql`, nunca SQL manual, usar parámetro `limit` en vez de LIMIT en SQL), ver `guides/stratio-data-tools.md` sec 3 y 6.
