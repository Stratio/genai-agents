...
- En no-2xx: muestra el código HTTP y el cuerpo tal cual. Consulta `guides/external-api-calls.md` §5 para interpretar códigos comunes (`401/403` = mTLS o RBAC; `400/422` = validación).
