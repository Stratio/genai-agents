...
Vertical de análisis de datos para Stratio Cowork. Empaqueta el agente `data-analytics`: un analista senior BI/BA que convierte preguntas de negocio en análisis accionables con datos reales de dominios gobernados.

## Qué incluye

| Agente | Propósito |
|---|---|
| [data-analytics](../../agents/data-analytics/) | Flujo BI/BA completo: descubrimiento de datos sobre dominios gobernados, EDA y profiling, análisis dirigido por hipótesis con Python (pandas, scipy, scikit-learn), visualizaciones (matplotlib, seaborn, plotly), y generación de entregables multi-formato (PDF, DOCX, PPTX, Dashboard web, Artículo web, Póster/Infografía, XLSX). |
