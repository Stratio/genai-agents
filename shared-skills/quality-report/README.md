...
- For file formats (PDF, DOCX, PPTX, Dashboard web, Poster/Infographic, XLSX): resolves the brand theme through the host agent's branding cascade, loads the matching writer skill and produces the deliverable applying brand tokens and following `quality-report-layout.md`.
