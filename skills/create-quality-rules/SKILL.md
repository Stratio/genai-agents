...
**About dimensions**: the domain definitions (obtained during the coverage assessment via `get_quality_rule_dimensions`) always prevail over standard ones. See section 2 of `guides/quality-exploration.md`.
