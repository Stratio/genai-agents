...
[ -n "$ARG_GOV_URL" ] && PLUGIN_ARGS+=(--gov-url "$ARG_GOV_URL")
[ -n "$ARG_GOV_KEY" ] && PLUGIN_ARGS+=(--gov-key "$ARG_GOV_KEY")
[ -n "$ARG_SQL_URL" ] && PLUGIN_ARGS+=(--sql-url "$ARG_SQL_URL")
[ -n "$ARG_SQL_KEY" ] && PLUGIN_ARGS+=(--sql-key "$ARG_SQL_KEY")
