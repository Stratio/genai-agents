...
This is the single analytical engine of the agent. Deliverable generation is delegated to `pdf-writer`, `docx-writer`, `pptx-writer`, `web-craft`, `canvas-craft` + `brand-kit`.
